...
impl PdCompat {
    pub fn bang(id: SurfaceId, pos: [f32; 2], size: f32, flash_state: f32, is_focused: bool) -> Vec<SurfacePrimitive> {
        ...
        primitives.push(SurfacePrimitive::Indicator {
            id,
            rect: [pos[0] + size * 0.15, pos[1] + size * 0.15, size * 0.7, size * 0.7],
    ...
    pub fn toggle(id: SurfaceId, pos: [f32; 2], size: f32, is_on: bool, is_focused: bool) -> Vec<SurfacePrimitive> {
        let mut primitives = Vec::new();
        ...
        primitives.push(SurfacePrimitive::Indicator {
            id,
            rect: [pos[0] + size * 0.2, pos[1] + size * 0.2, size * 0.6, size * 0.6],
