...
impl DesignerState {
    ...
    pub fn draw(
        ...
        ui: &mut egui::Ui,
        rect: egui::Rect,
        layout: &mut limestudio_core::view::DesignerLayout,
    ) {
        ...
        for ((node_id, param_name), widget) in &mut layout.widgets {
            ...
            match widget.widget_type {
                ...
                WidgetType::Meter => {
                    crate::widgets::level_meter(
                        ui,
                        &crate::widgets::MeterState {
                            peak: 0.7,
                            rms: 0.4,
                        },
                    );
    ...
    pub fn suggest_widget(&self, unit: SignalUnit) -> WidgetType {
        match unit {
            SignalUnit::Hertz | SignalUnit::Normalized | SignalUnit::Bipolar => {
                WidgetType::ModulationRing
            }
