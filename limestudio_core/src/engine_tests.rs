...
mod tests {
    ...
    fn test_engine_gain_processing() {
        ...
        let gain_node = builder.add_processor("Gain", vec![("gain", crate::graph::ParamSource::Parameter("gain".to_string()))]);
        ...
        engine.handle_event(crate::engine::VoiceEvent::NoteOn { pitch: 60, velocity: 1.0 });
        ...
        prod.push(PatchEvent::SetParameter { param_id: "gain".to_string(), value: 0.5 }).unwrap();
        ...
        prod.push(PatchEvent::SetParameter { param_id: "gain".to_string(), value: 2.0 }).unwrap();
